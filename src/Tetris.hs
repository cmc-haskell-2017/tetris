...
genFigure a | a== 0  =  Figure O DUp (blockSize*4 , 0,0) 
            | a== 1  =  Figure I DUp (blockSize*4, 0,1) 
            | a== 2  =  Figure T DUp (blockSize*4, 0,2) 
            | a== 3  =  Figure J DUp (blockSize*4, 0,3) 
            | a== 4  =  Figure L DUp (blockSize*4, 0,4) 
            | a== 5  =  Figure S DUp (blockSize*4, 0,5) 
            | a== 6  =  Figure Z DUp (blockSize*4, 0,6) 
------------------------------------------------------------------------------------------------------------------------------------------
...
drawBlock  (b,c,1) |(b==0)=   pictures [ translate (-w) h (scale  1.3 1.3 (pictures
 [ --color magenta (rotate (35 ) (thickArc (fromIntegral (0 )) (fromIntegral (36 )) (fromIntegral (c + 5) / 5 ) (fromIntegral 6) )),
  color blue  (thickArc (fromIntegral (0  )) (fromIntegral (36  )) (fromIntegral (c + 5) / 5  ) (fromIntegral 6) )             -- белая рамка
   

   ]))
    ]
                    |(b==270) = 
    color blue   (thickArc (324) (359) (fromIntegral (c + 5) / 5  - 2) (fromIntegral 6) )                  
 ...
 [ --color magenta (rotate (fromIntegral(-b) ) (thickArc (fromIntegral (0 )) (fromIntegral (36 )) (fromIntegral (c + 5) / 5 ) (fromIntegral 6) )),
  ...
  w = fromIntegral 0
  h = fromIntegral 0
drawBlock  (b,c,2) |(b==0)=   pictures [ translate (-w) h (scale  1.3 1.3 (pictures
 [ --color magenta (rotate (35 ) (thickArc (fromIntegral (0 )) (fromIntegral (36 )) (fromIntegral (c + 5) / 5 ) (fromIntegral 6) )),
  color yellow  (thickArc (fromIntegral (0  )) (fromIntegral (36  )) (fromIntegral (c + 5) / 5  ) (fromIntegral 6) )             -- белая рамка
   

   ]))
    ]
                        |(b==270) = 
    color yellow   (thickArc (324) (359) (fromIntegral (c + 5) / 5  - 2) (fromIntegral 6) ) 
                   |otherwise = pictures [ translate (-w) h (scale  1.3 1.3 (pictures
 [ --color magenta (rotate (fromIntegral(-b) ) (thickArc (fromIntegral (0 )) (fromIntegral (36 )) (fromIntegral (c + 5) / 5 ) (fromIntegral 6) )),
  ...
  w = fromIntegral 0
  h = fromIntegral 0
drawBlock  (b,c,3) |(b==0)=   pictures [ translate (-w) h (scale  1.3 1.3 (pictures
 [ --color magenta (rotate (35 ) (thickArc (fromIntegral (0 )) (fromIntegral (36 )) (fromIntegral (c + 5) / 5 ) (fromIntegral 6) )),
  color red  (thickArc (fromIntegral (0  )) (fromIntegral (36  )) (fromIntegral (c + 5) / 5  ) (fromIntegral 6) )             -- белая рамка
   

   ]))
    ]
                 |(b==270) = 
    color red   (thickArc (324) (359) (fromIntegral (c + 5) / 5  - 2) (fromIntegral 6) ) 
                   |otherwise = pictures [ translate (-w) h (scale  1.3 1.3 (pictures
 [ --color magenta (rotate (fromIntegral(-b) ) (thickArc (fromIntegral (0 )) (fromIntegral (36 )) (fromIntegral (c + 5) / 5 ) (fromIntegral 6) )),
  ...
  w = fromIntegral 0
  h = fromIntegral 0
drawBlock  (b,c,4) |(b==0)=   pictures [ translate (-w) h (scale  1.3 1.3 (pictures
 [ --color magenta (rotate (35 ) (thickArc (fromIntegral (0 )) (fromIntegral (36 )) (fromIntegral (c + 5) / 5 ) (fromIntegral 6) )),
  color green  (thickArc (fromIntegral (0  )) (fromIntegral (36  )) (fromIntegral (c + 5) / 5  ) (fromIntegral 6) )             -- белая рамка
   

   ]))
    ]
                  |(b==270) = 
    color green   (thickArc (324) (359) (fromIntegral (c + 5) / 5  - 2) (fromIntegral 6) ) 
                   |otherwise = pictures [ translate (-w) h (scale  1.3 1.3 (pictures
 [ --color magenta (rotate (fromIntegral(-b) ) (thickArc (fromIntegral (0 )) (fromIntegral (36 )) (fromIntegral (c + 5) / 5 ) (fromIntegral 6) )),
  ...
  w = fromIntegral 0
  h = fromIntegral 0
drawBlock  (b,c,5) |(b==0)=   pictures [ translate (-w) h (scale  1.3 1.3 (pictures
 [ --color magenta (rotate (35 ) (thickArc (fromIntegral (0 )) (fromIntegral (36 )) (fromIntegral (c + 5) / 5 ) (fromIntegral 6) )),
  color orange  (thickArc (fromIntegral (0  )) (fromIntegral (36  )) (fromIntegral (c + 5) / 5  ) (fromIntegral 6) )             -- белая рамка
   

   ]))
    ]
                  |(b==270) = 
    color orange   (thickArc (324) (359) (fromIntegral (c + 5) / 5  - 2) (fromIntegral 6) ) 
                   |otherwise = pictures [ translate (-w) h (scale  1.3 1.3 (pictures
 [ --color magenta (rotate (fromIntegral(-b) ) (thickArc (fromIntegral (0 )) (fromIntegral (36 )) (fromIntegral (c + 5) / 5 ) (fromIntegral 6) )),
  ...
  w = fromIntegral 0
  h = fromIntegral 0
drawBlock  (b,c,_) |(b==0)=   pictures [ translate (-w) h (scale  1.3 1.3 (pictures
 [ --color magenta (rotate (35 ) (thickArc (fromIntegral (0 )) (fromIntegral (36 )) (fromIntegral (c + 5) / 5 ) (fromIntegral 6) )),
  color white  (thickArc (fromIntegral (0  )) (fromIntegral (36  )) (fromIntegral (c + 5) / 5  ) (fromIntegral 6) )             -- белая рамка
   

   ]))
    ]
                 |(b==270) = 
    color white   (thickArc (324) (359) (fromIntegral (c + 5) / 5  - 2) (fromIntegral 6) ) 
                   |otherwise = pictures [ translate (-w) h (scale  1.3 1.3 (pictures
 [ --color magenta (rotate (fromIntegral(-b) ) (thickArc (fromIntegral (0 )) (fromIntegral (36 )) (fromIntegral (c + 5) / 5 ) (fromIntegral 6) )),
